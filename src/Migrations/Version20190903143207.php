 ...
 */
final class Version20190903143207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE edge ADD CONSTRAINT FK_7506D366460D9FD7 FOREIGN KEY (node_id) REFERENCES node (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE edge ADD CONSTRAINT FK_7506D3665D4BE7AA FOREIGN KEY (directed_node_id) REFERENCES node (id) ON DELETE CASCADE');
    }
